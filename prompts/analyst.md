...
TRADE_THIS: YES only: confidence>={confidence_threshold}, R:R>={min_rr}:1, MTF weekly+daily both agree, >=4 fundamental layers agree. UNAVAILABLE=1. Conf<={below_threshold}=NO always.
