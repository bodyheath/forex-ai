...
checks = [
    ...
    ('Dynamic sizing',           r'_calculate_position_size',         'daily.py',                     True),
    ('Session filter',           r'_check_session_filter',            'daily.py',                     True),
    ('News blackout',            r'_has_upcoming_news',               'daily.py',                     True),
    ('Entry validation',         r'_validate_entry_price',            'daily.py',                     True),
    ('Trailing stop',            r'_update_trailing_stop',            'src/monitor.py',               True),
    ('Pending entries',          r'_check_pending_trades',            'src/monitor.py',               True),
    ('Close trade (outcome)',    r'update_outcome',                   'src/monitor.py',               True),
