...
checks = [
    ...
    ('Dynamic sizing',         '_get_position_size',          'daily.py',                        True),
    ('Session filter',         '_session_ok',                 'daily.py',                        True),
    ('News blackout',          '_has_news_blackout',          'daily.py',                        True),
    ('Entry validation',       '_validate_entry_price',       'daily.py',                        True),
    ('Trailing stop',          '_update_trailing_stop',       'src/monitor.py',                  True),
    ('Pending entries',        '_check_pending_entries',      'src/monitor.py',                  True),
    ('Close before alert',     'close_fund_trade',            'src/monitor.py',                  True),
