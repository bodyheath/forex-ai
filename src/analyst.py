...
def _haiku_system_prompt(threshold_override: "float | None" = None) -> str:
    ...
    return (
        ...
        "  RSI tiers (standard/mixed MTF): <30=9-10BUY  30-35=7-8BUY  35-45=5-6BUY  45-55=3-4NEUTRAL  "
        "55-65=4-5SELL  65-70=7-8SELL  >70=9-10SELL\n"
        ...
        "shift BUY zones lower: RSI<20=9-10BUY, 20-30=7-8BUY, 30-42=5-6BUY; RSI 42-55=NEUTRAL(3-4) "
        ...
        "shift SELL zones higher: RSI>80=9-10SELL, 70-80=7-8SELL, 58-70=4-5SELL; RSI 45-58=NEUTRAL(3-4) "
        "— do NOT score 4-5SELL just because RSI is 60-65 in an uptrend.\n"
