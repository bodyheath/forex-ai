...
- PARAMETER: _elig_h_oscillator_extremity.quality_grades (src/virtual_books.py)
- PARAMETER: _elig_h_oscillator_extremity.dd_mode (src/virtual_books.py)
- PARAMETER: _elig_h_oscillator_extremity.conf_threshold (src/virtual_books.py)
- PARAMETER: _elig_h_oscillator_extremity.eff_conf_fn (src/virtual_books.py)
- PARAMETER: _elig_h_oscillator_extremity.dd_allows_fn (src/virtual_books.py)
- PARAMETER: _elig_i_bollinger_extremity.quality_grades (src/virtual_books.py)
- PARAMETER: _elig_i_bollinger_extremity.dd_mode (src/virtual_books.py)
- PARAMETER: _elig_i_bollinger_extremity.conf_threshold (src/virtual_books.py)
- PARAMETER: _elig_i_bollinger_extremity.eff_conf_fn (src/virtual_books.py)
- PARAMETER: _elig_i_bollinger_extremity.dd_allows_fn (src/virtual_books.py)
